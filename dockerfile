...
RUN mkdir -p database /var/data storage/framework/{sessions,views,cache} storage/logs bootstrap/cache && \
    ...
    chown -R www-data:www-data storage bootstrap/cache /var/data 2>/dev/null || true
