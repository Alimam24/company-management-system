    ...
    <div class="bg-slate-50 min-h-screen py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-xl border border-slate-200 p-8">
                <h1 class="text-3xl font-bold text-slate-900 mb-6">Create New Offer</h1>

                <form method="POST" action="{{ route('marketing.offers.store') }}">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="Description" id="Description" rows="4"
                                class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">{{ old('Description') }}</textarea>
                            @error('Description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
