            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                    <div class="mb-6 sm:mb-0">
                        ...
                        <p class="text-slate-600 mt-2 text-lg">Manage warehouse employees and assignments</p>
                    </div>

                    <a href="{{ route('warehouses.employees.assign.page', $warehouse) }}"
                ...
                <form method="GET" class="mb-6 flex flex-col sm:flex-row gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-purple-700 hover:bg-purple-800 text-white font-medium rounded-lg transition">
                        Filter
                    </button>
                </form>
                            ...
                            @foreach ($employees as $employee)
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <form method="POST" action="{{ route('warehouses.employee.destroy', ['warehouse' => $warehouse, 'employee' => $employee]) }}">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <tr class="sm:hidden">
                                    <td class="p-0">
                                        <div class="p-4 border-b border-slate-200 hover:bg-slate-50 transition-colors">
                                            ...
                                            <form
                                                action="{{ route('warehouses.employee.destroy', ['warehouse' => $warehouse, 'employee' => $employee]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button onclick="return confirm('Remove this employee?')"
