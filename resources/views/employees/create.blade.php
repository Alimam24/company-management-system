<x-layouts.app>
    ...
    <form method="POST" action="/employees" enctype="multipart/form-data" class="max-w-3xl mx-auto py-6 space-y-8">
        @csrf
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <h2 class="text-base font-semibold leading-7 text-gray-900 mt-10">Enter Employee Information:</h2>
