<x-layouts.app>
    <x-slot:heading>
        Assign Manager to {{ $store->StoreName }}
    </x-slot>
        ...
        <div class="min-h-screen py-12">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-slate-600 text-lg">Select a manager for this store. Only employees with manager role can be assigned.</p>
                </div>
                ...
                <form method="POST" action="{{ route('stores.manager.assign.submit', $store) }}">
                    @csrf
