<x-layouts.app>
    <x-slot:heading>
        Assign Products to {{ $store->StoreName }}
    </x-slot>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                    <div class="mb-6 sm:mb-0">
                        ...
                        <p class="text-slate-600 mt-2 text-lg">Select products and specify quantities for {{ $store->StoreName }}</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('stores.products.assign.submit', $store) }}" id="assignForm">
                    @csrf
                        ...
                        @else
                            <div class="p-12 text-center">
                                <p class="text-slate-600 text-lg mb-4">
                                    ...
                                    @else
                                        No products available to assign. All products are already assigned to this store.
                                    @endif
                                </p>
                                <a href="{{ route('stores.products', $store) }}"
