<x-layouts.app>
    ...
    @include('partials.store_searchbar')
        ...
        @foreach ($stores as $store)
            <a href="/stores/{{ $store->id }}">
                ...
                <article
                    ...
                    <!-- Store Name -->
                    <h2 class="text-2xl font-bold text-gray-900 mb-4 truncate">{{ $store->StoreName }}</h2>
                    ...
                    <div class="space-y-3 flex-1 overflow-hidden">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 truncate">
                                ...
                                <p class="text-base text-gray-900 truncate">{{ $store->City->Name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 truncate">
                                ...
                                <p class="text-base text-gray-900 truncate">{{ $store->Address }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 truncate">
                                ...
                                <p class="text-base text-gray-900 truncate">{{ $store->Phone }}</p>
                            </div>
                        </div>
                    </div>
                </article>
